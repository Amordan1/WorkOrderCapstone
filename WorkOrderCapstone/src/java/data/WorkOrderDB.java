...
public class WorkOrderDB {
    ...
    public static void updateUser(User user) throws SQLException {
        ...
        String query
                = "UPDATE RMFall22.EndUser SET UserName = ? Password = ?, AccountAge = ?, Email = ?, FirstName = ?, LastName = ?, Phone = ?, RoleID = ?, Street = ?, City = ?, State = ?, zip = ? "
                + "WHERE CustomerID = ?";
        ...
        try {
            ...
            ps.setString(11, user.getState());
            ps.setInt(12, user.getZip());  
            ps.setInt(13, user.getCustomerID());
    ...
    public static void createNewOrder(WorkOrder order) throws SQLException {
        ...
        try {
            ...
            ps.setDate(4, Date.valueOf(order.getWorkOrderEnd()));
            ps.setDate(5, Date.valueOf(order.getWorkOrderEstEnd()));
